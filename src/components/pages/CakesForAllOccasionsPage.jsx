...
const cakesData = {
  ...
  flavors: [
    ...
    { name: 'Rasmalai',       price6: 40, price8: 60, price10: 95, description: 'Soft vanilla base soaked in rasmalai milk with rasmalai fresh cream and nuts', label: 'Best-seller' },
    { name: 'Rose Cardamom',  price6: 30, price8: 50, price10: 80, description: 'Rose infused vanilla base with aromatic cardamom fresh cream', label: null },
    { name: 'Gulab Jamun',    price6: 40, price8: 60, price10: 95, description: 'Soft vanilla base soaked in rose syrup with cardamom fresh cream and gulab jamun bits and nuts', label: null },
    ...
    { name: 'Red Velvet',     price6: 35, price8: 55, price10: 85, description: 'Classic velvet base with light and fluffy cream cheese frosting', label: null },
    { name: 'Coconut Raspberry', price6: 35, price8: 55, price10: 85, description: 'Vanilla base with homemade raspberry compote and creamy coconut buttercream', label: null },
    { name: 'Nutella',        price6: 35, price8: 55, price10: 85, description: 'Moist chocolate base with rich nutella buttercream topped with hazelnuts', label: null },
